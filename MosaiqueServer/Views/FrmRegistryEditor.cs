...
namespace MosaiqueServeur.Views
{
    public partial class FrmRegistryEditor : Form
    {
        ...
        private void FrmRegistryEditor_Load(object sender, EventArgs e)
        {
            ...
            lstRegistryValues.SmallImageList = imageRegistryValue;
        ...
        private void PopulateLstRegistryValues(RegValueData[] values)
        {
            ...
            {
                if(value.Kind == RegistryValueKind.String || value.Kind == RegistryValueKind.ExpandString)
                {
                    if (value.Data != null)
                    {
                        try
                        {
                            ...
                            var StrRewrited = serializer.DeserializeObject(value.Data);
                            value.Data = StrRewrited.ToString();
                        }
                        catch
                        {
                ...
                RegistryValueLstItem item = new RegistryValueLstItem(value);
                if (value.Kind == RegistryValueKind.String || value.Kind == RegistryValueKind.ExpandString || value.Kind == RegistryValueKind.MultiString)
                        item.ImageIndex = 0;
                else
                    item.ImageIndex = 1;
        ...
        private void lstRegistryKeys_AfterLabelEdit(object sender, LabelEditEventArgs e)
        {
            if (e.Label != null && tvRegistryDirectory.SelectedNode != null)
            {
                ...
                if (e.Label.Length > 0)
                {
                    ...
                    new DoRenameRegistryValue(tvRegistryDirectory.SelectedNode.FullPath, lstRegistryValues.Items[index].Name, e.Label).Execute(_connectClient);
        ...
        private void createNewRegistryKey_Click(object sender, EventArgs e)
        {
            if (!(tvRegistryDirectory.SelectedNode.IsExpanded) && tvRegistryDirectory.SelectedNode.Nodes.Count > 0)
            {
                ...
                tvRegistryDirectory.AfterExpand += new TreeViewEventHandler(this.createRegistryKey_AfterExpand);
        ...
        private void createStringRegistryValue_Click(object sender, EventArgs e)
        {
            if (tvRegistryDirectory.SelectedNode != null)
            {
                ...
                new DoCreateRegistryValue(tvRegistryDirectory.SelectedNode.FullPath, RegistryValueKind.String).Execute(_connectClient);
            }
        }
        ...
        private void createBinaryRegistryValue_Click(object sender, EventArgs e)
        {
            if (tvRegistryDirectory.SelectedNode != null)
            {
                ...
                new DoCreateRegistryValue(tvRegistryDirectory.SelectedNode.FullPath, RegistryValueKind.Binary).Execute(_connectClient);
            }
        }
        ...
        private void createDwordRegistryValue_Click(object sender, EventArgs e)
        {
            if (tvRegistryDirectory.SelectedNode != null)
            {
                ...
                new DoCreateRegistryValue(tvRegistryDirectory.SelectedNode.FullPath, RegistryValueKind.DWord).Execute(_connectClient);
            }
        }
        ...
        private void createQwordRegistryValue_Click(object sender, EventArgs e)
        {
            if (tvRegistryDirectory.SelectedNode != null)
            {
                ...
                new DoCreateRegistryValue(tvRegistryDirectory.SelectedNode.FullPath, RegistryValueKind.QWord).Execute(_connectClient);
            }
        }
        ...
        private void createMultiStringRegistryValue_Click(object sender, EventArgs e)
        {
            if (tvRegistryDirectory.SelectedNode != null)
            {
                ...
                new DoCreateRegistryValue(tvRegistryDirectory.SelectedNode.FullPath, RegistryValueKind.MultiString).Execute(_connectClient);
            }
        }
        ...
        private void createExpandStringRegistryValue_Click(object sender, EventArgs e)
        {
            if (tvRegistryDirectory.SelectedNode != null)
            {
                ...
                new DoCreateRegistryValue(tvRegistryDirectory.SelectedNode.FullPath, RegistryValueKind.ExpandString).Execute(_connectClient);
            }
        }
            ...
            if (answer == DialogResult.Yes)
            {
                foreach (var item in lstRegistryValues.SelectedItems)
                {
                    if (item.GetType() == typeof(RegistryValueLstItem))
                    {
                        ...
                        new DoDeleteRegistryValue(tvRegistryDirectory.SelectedNode.FullPath, registyValue.RegName).Execute(_connectClient);
                    }
                }
            }
        }
